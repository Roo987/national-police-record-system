...
<head>
  ...
  <title>Crime record management system - Index</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html">National Police Service</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#report crime">Report a crime</a></li>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>An easy way to report crimes.</h1>
      <h2>National Police Service. Utumishi kwa wote.</h2>
      <a href="./crms login and signup/MAIN.php" class="btn-get-started scrollto">Get Started</a>
    </div>
  </section><!-- End Hero -->
