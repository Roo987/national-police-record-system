...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Region deleted!!";
		  }
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Successful!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text" placeholder="Enter Region Name"  name="state" class="span8 tip" required>
</div>
</div>
