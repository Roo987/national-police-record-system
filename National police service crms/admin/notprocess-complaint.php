...
<tbody>
<?php 
$query=mysqli_query($bd, "select tblcomplaints.*,complainant.username as name from tblcomplaints join complainant on complainant.id=tblcomplaints.userId where tblcomplaints.status is null ");
