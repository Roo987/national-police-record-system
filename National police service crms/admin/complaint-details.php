...
<head>
	...
	<title>Admin| Crime Complaint Details</title>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/source/National%20police%20service%20crms/admin/update-complaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											<br> <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/source/National%20police%20service%20crms/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
