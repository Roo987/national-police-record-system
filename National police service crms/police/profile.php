...
$query=mysqli_query($bd, "update police set fname='$fname',lname='$lname',phone='$phone',address='$address',state='$state' where username='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>CRMS | Police profile</title>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <b>Oops!Something went wrong</b> </b> <?php echo htmlentities($errormsg);?></div>
                      <?php }?>
 <?php $query=mysqli_query($bd, "select * from police where username='".$_SESSION['login']."'");
 while($row=mysqli_fetch_array($query)) 
 {
 ?>                     

  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['lname']);?>'s Profile</h4>
...
<label class="col-sm-2 col-sm-2 control-label">First Name </label>
 <div class="col-sm-4">
<input type="text" name="fname" required="required" value="<?php echo htmlentities($row['fname']);?>" class="form-control">
</div>
<label class="col-sm-2 col-sm-2 control-label">Last Name</label>
 <div class="col-sm-4">
<input type="text" name="lname" required="required" value="<?php echo htmlentities($row['lname']);?>" class="form-control" >
</div>
 </div>
