...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Crime record Details</h3>
            <hr />

 <?php $query=mysqli_query($bd, "select tblborrowed.*,category.categoryName as catname from tblborrowed join category on category.id=tblborrowed.category where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
while($row=mysqli_fetch_array($query))
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Reported Crime Number : </b></label>
          		<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Crime Type :</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Region :</b></label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nature of Crime :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b> Details on Crime </label>
              <div class="col-sm-10">
