...
{
$sql=mysqli_query($bd, "SELECT password FROM  complainant where password='".md5($_POST['password'])."' && email='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update complainant set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where email='".$_SESSION['login']."'");
