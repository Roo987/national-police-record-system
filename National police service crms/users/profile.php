...
$query=mysqli_query($bd, "update complainant set username='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode' where email='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>CRMS | User Change Password</title>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysqli_query($bd, "select * from complainant where email='".$_SESSION['login']."'");
