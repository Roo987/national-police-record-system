...
{
$ret=mysqli_query($bd, "SELECT * FROM complainant WHERE email='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$query=mysqli_query($bd, "SELECT * FROM complainant WHERE email='$email' and contactNo='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($bd, "update complainant set password='$password' WHERE email='$email' and contactNo='$contact' ");
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            ...
		            <div class="registration">
		                ...
		                <a class="" href="../crms login and signup/complainant-signup.php">
		                    Create an account
		                </a>
		            </div>
